  ...
  return (
    ...
    w-full text-sm text-slate-500 bg-white pt-16">
      ...
      <div className="relative grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
        ...
        {/* Quick Links */}
        <div>
          <h2 className="font-semibold mb-5 text-gray-800"></h2>
      ...
      gap-4 py-6 border-t mt-12 border-slate-200 text-xs sm:text-sm">
        <p className="text-center">
          ...
          <Link to="/" 
          className="hover:text-green-600 transition">Hotelify</Link>. All Rights Reserved.
        </p>
        <div className="flex items-center gap-4">
        <Link to="/privacy" 
           className="hover:text-green-600 transition">Privacy Policy</Link>
        <Link to="/terms" 
           className="hover:text-green-600 transition">Terms of Service</Link>
        <Link to="/cookies" 
           className="hover:text-green-600 transition">Cookie Policy</Link>
        </div>
      </div>
    </footer>
  )
